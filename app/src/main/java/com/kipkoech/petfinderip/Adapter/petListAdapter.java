...
//        }
        ...
        public void bindRestaurant(Animal genders) {
            mNameTextView.setText(genders.getName());
            mCategoryTextView.setText(genders.getGender());
            mRatingTextView.setText("description " + genders.getDescription());

            for(int i=0;i<genders.getPhotos().size();i++){
                Log.d("Photo","photo sizes"+genders.getPhotos().get(i));
                String photo = genders.getPhotos().get(i).getFull();
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("genders", Parcels.wrap(mPets));
